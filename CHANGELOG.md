...
- `docs/delta-audit.md` (dir #207, PR2 of 2): the full procedure that adopts `tools/delta-audit/
  ...
  cross-reference distinguishing its own previous-run-baseline scope — covering every measured scope,
  prose and code alike — from this doc's release-range scope.
