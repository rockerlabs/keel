...
- **`docs/release-audit.md`'s phase 7 now tells the release-prep session to write the
  ...
  this step the v0.8.0 tag would have repeated 2026-08-29's repo-wide CHANGELOG-reconciliation red.
  Keel-self-maintenance: `docs/release-audit.md` governs keel's own release process and is never
  installed into an adopter project.
