...
*Not the same shape as [`docs/delta-audit.md`](delta-audit.md): this section's incremental scope
covers every measured scope — prose (A, B) and code (C) alike — keyed to the **previous drydock
