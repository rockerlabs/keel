...
commit/tag metadata, private tokens in old blobs and messages). [`public-audit`](../tools/public-audit.sh)
**detects** both; this page is the **procedure** to fix them and flip without churn.
